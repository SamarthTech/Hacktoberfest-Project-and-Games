...
- Clone your forked repository to your pc `git clone https://github.com/SamarthTech/Hacktoberfest-Project-and-Games.git`

  ```bash
  git clone https://github.com/SamarthTech/Hacktoberfest-Project-and-Games.git
  ```
